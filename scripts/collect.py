...
ARTICLE_NEWS_QUERIES = [
    (
        "기사",
        "언론-도시계획",
        "(도시계획 OR 국토계획 OR 도시관리계획 OR 도시기본계획 "
        "OR 도시군관리계획 OR 도시·군관리계획 OR 도시군기본계획 "
        "OR 도시·군기본계획 OR 공간재구조화 OR 도시혁신구역)",
    ),
    (
        "기사",
        "언론-지구단위",
        "(지구단위계획 OR 특별계획구역 OR 획지 OR 필지 "
        "OR 용도지역 OR 용도지구 OR 용적률 OR 건폐율 OR 밀도 "
        "OR 공공기여 OR 기부채납 OR 사전협상)",
    ),
    (
        "기사",
        "언론-정비사업",
        "(재개발 OR 재건축 OR 정비사업 OR 정비구역 "
        "OR 정비사업조합 OR 재건축조합 OR 재개발조합 "
        "OR 사업시행자 OR 신속통합기획 OR 모아타운 "
        "OR 노후계획도시 OR 특별정비구역)",
    ),
    (
        "기사",
        "언론-주택공급",
        "(공공주택 OR 주택공급 OR 역세권 복합개발 OR 도심복합사업 "
        "OR 도심공공주택복합사업 OR 도심 공공주택 복합사업 "
        "OR 역세권청년주택 OR 역세권 청년주택 "
        "OR 역세권활성화사업 OR 역세권 활성화사업 "
        "OR 안심주택 OR 택지개발)",
    ),
    (
        "기사",
        ...
        "OR 도심융합특구 OR 기회발전특구 OR 지역개발사업 "
        "OR 5극3특 OR 시도 통합 OR 시·도 통합 "
        "OR 통합지자체 OR 초광역권)",
    ),
    (
        "기사",
        "언론-교통공간",
        "(철도지하화 OR GTX OR 광역교통 OR 역세권 OR 도시철도 "
        "OR 하이퍼루프 OR 하이퍼튜브 OR UAM OR PAV OR 컴팩트시티)",
    ),
    (
        "기사",
        "언론-도시재생",
        "(도시재생 OR 빈집 OR 원도심 OR 상권활성화 "
        "OR 골목상권 OR 아케이드)",
    ),
    (
        "기사",
        "언론-공업지역산업단지",
        "(공업지역 OR 준공업지역 OR 준공업 OR 도시공업지역 "
        "OR 산업단지 OR 산업입지 OR 산업입지법 OR 산업단지계획 "
        "OR 노후산업단지 OR 산단재생 OR 산업단지 재생 "
        "OR 산업단지 대개조 OR 도시첨단산업단지 "
        "OR 국가산업단지 OR 일반산업단지 OR 농공단지 "
        "OR 산업단지관리기본계획 OR 산업단지개발계획 "
        "OR 산업시설구역 OR 공업용지 OR 공장입지)",
    ),
    (
        "기사",
        "언론-스마트기후",
        "(스마트시티 OR 스마트도시 OR 도시데이터 OR URBAN AI "
        "OR AI CITY OR Urban AI OR AI City OR 탄소중립 "
        "OR 침수 OR 폭염)",
    ),
]
...
RELEVANT_WORDS = (
    ...
    "공실", "침수", "폭염",
    "필지", "획지", "대지", "가구", "용적률", "건폐율", "밀도",
    "개발밀도", "조합", "정비사업조합", "재건축조합", "재개발조합",
    "시행자", "사업시행자", "토지등소유자",
    "공간재구조화", "도시혁신구역", "도시군관리계획", "도시·군관리계획",
    "도시군기본계획", "도시·군기본계획", "기부채납", "특별계획구역",
    "사전협상", "특별정비구역", "도심공공주택복합사업",
    "도심 공공주택 복합사업", "역세권청년주택", "역세권 청년주택",
    "역세권활성화사업", "역세권 활성화사업", "안심주택",
    "지역개발사업", "5극3특", "시도 통합", "시·도 통합",
    "통합지자체", "초광역권", "하이퍼루프", "하이퍼튜브",
    "UAM", "PAV", "컴팩트시티", "아케이드", "URBAN AI", "AI CITY",
    "Urban AI", "AI City",
    "공업지역", "준공업", "준공업지역", "도시공업지역", "도시공업지역법",
    "노후산업단지", "산업입지", "산업입지법", "산업단지계획",
    "산업단지관리기본계획", "산업단지개발계획", "산단재생",
    "산업단지 재생", "산업단지 대개조", "도시첨단산업단지",
    "국가산업단지", "일반산업단지", "농공단지", "산업시설구역",
    "복합구역", "공업용지", "공장입지", "산업단지구조고도화",
)
# ── 수정: 장르어 추가 ─────────────────────────────────────────────────
STOPWORDS = {
...
TOPICS = {
    "주택공급·공공주택": (
        ...
        "도심공공주택복합사업", "도심 공공주택 복합사업",
        "역세권청년주택", "역세권 청년주택",
        "역세권활성화사업", "역세권 활성화사업", "안심주택",
    ),
    "재건축·재개발·정비사업": (
        "재건축", "재개발", "정비사업", "노후계획도시", "1기 신도시",
        "특별정비구역", "조합", "정비사업조합", "사업시행자", "시행자",
    ),
    "지역소멸·균형발전": (
    ...
    "국토계획·용도지역·규제": (
        "국토계획", "도시계획", "도시군관리계획", "도시·군관리계획",
        "도시군기본계획", "도시·군기본계획", "공간재구조화",
        "도시혁신구역", "용도지역", "용도지구", "지구단위계획",
        "필지", "획지", "대지", "가구", "개발제한구역",
        "그린벨트", "용적률", "건폐율", "밀도", "개발밀도",
        "기부채납", "특별계획구역", "사전협상",
    ),
    "공업지역·산업단지 제도": (
        "공업지역", "준공업", "준공업지역", "도시공업지역",
        "도시공업지역법", "산업단지", "산업입지", "산업입지법",
        "산업단지계획", "산업단지관리기본계획", "산업단지개발계획",
        "노후산업단지", "산단재생", "산업단지 재생", "산업단지 대개조",
        "도시첨단산업단지", "국가산업단지", "일반산업단지", "농공단지",
        "산업시설구역", "복합구역", "공업용지", "공장입지",
        "산업단지구조고도화",
    ),
    "산업단지·지역산업 전환": (
        "산업단지", "국가산단", "국가산업단지", "도시첨단산업단지",
        "산업전환", "기업도시", "첨단산업", "노후산업단지",
    ),
    "스마트시티·AI·디지털전환": (
        "스마트시티", "스마트도시", "인공지능", "디지털트윈",
        "자율주행", "도시데이터", "URBAN AI", "AI CITY",
        "Urban AI", "AI City",
    ),
    "기후위기·탄소중립·녹색건축": (
    ...
    "토지·부동산시장": (
        "부동산", "토지거래", "집값", "지가", "공시가격", "전세", "매매가격",
    ),
    "관광·지역개발": (
        "관광단지", "지역개발", "지역개발사업", "관광개발",
        "문화도시", "복합개발", "워케이션",
    ),
    "도시안전·재난 대응": (
...
KEYWORD_PHRASES = {
    ...
    "건폐율": ("건폐율",),
    "개발밀도": ("밀도", "개발밀도"),
    "조합": ("정비사업조합", "재건축조합", "재개발조합", "조합"),
    "사업시행자": ("사업시행자", "시행자"),
    "공간재구조화": ("공간재구조화",),
    "도시혁신구역": ("도시혁신구역",),
    "도시·군관리계획": ("도시군관리계획", "도시·군관리계획"),
    "도시·군기본계획": ("도시군기본계획", "도시·군기본계획"),
    "정비사업(재건축·재개발)": (
        "재건축", "재개발", "정비사업", "도시정비",
    ...
    "역세권청년주택": ("역세권청년주택", "역세권 청년주택"),
    "역세권활성화사업": ("역세권활성화사업", "역세권 활성화사업"),
    "안심주택": ("안심주택",),
    "임대주택": ("임대주택",),
    "주거복지": ("주거복지",),
    "도시재생": ("도시재생",),
    ...
    "지역개발사업": ("지역개발사업",),
    "5극3특": ("5극3특", "오극삼특"),
    "시도통합": ("시도 통합", "시·도 통합", "행정통합"),
    "통합지자체": ("통합지자체", "통합 지방자치단체"),
    "초광역권": ("초광역권", "초광역"),
    "기부채납": ("기부채납",),
    "특별계획구역": ("특별계획구역",),
    "사전협상": ("사전협상",),
    ...
    "공업지역": ("공업지역",),
    "준공업지역": ("준공업", "준공업지역"),
    "도시공업지역": ("도시공업지역", "도시공업지역법"),
    "산업단지": ("산업단지", "국가산단"),
    "산업입지": ("산업입지", "산업입지법"),
    "산업단지계획": ("산업단지계획", "산업단지 개발계획"),
    "산업단지관리기본계획": ("산업단지관리기본계획",),
    "노후산업단지": ("노후산업단지",),
    "산업단지재생": ("산단재생", "산업단지 재생", "산업단지구조고도화"),
    "산업단지대개조": ("산업단지 대개조",),
    "도시첨단산업단지": ("도시첨단산업단지",),
    "국가산업단지": ("국가산업단지",),
    "일반산업단지": ("일반산업단지",),
    ...
    "철도지하화": ("철도지하화",),
    "도시철도": ("도시철도",),
    "하이퍼루프·하이퍼튜브": ("하이퍼루프", "하이퍼튜브"),
    "UAM·PAV": ("uam", "pav", "UAM", "PAV"),
    "컴팩트시티": ("컴팩트시티", "compact city"),
    "도심융합특구": ("도심융합특구",),
    "기회발전특구": ("기회발전특구",),
    "스마트시티": ("스마트시티", "스마트도시"),
    "Urban AI": ("urban ai", "URBAN AI", "Urban AI"),
    "AI City": ("ai city", "AI CITY", "AI City"),
    "디지털트윈": ("디지털트윈",),
    "공공건축": ("공공건축",),
    "건축물관리": ("건축물관리", "노후건축물"),
    "녹색건축": ("녹색건축", "제로에너지"),
